- dashboard: mysql_database_observability
  title: "Cloud SQL Observability (MySQL)"
  layout: newspaper
  ...
  tabs:
    - name: mysql_fleet_overview_tab
      label: "Fleet Overview (Macro)"
    - name: mysql_instance_deep_dive_tab
      label: "Instance Deep Dive (Micro)"
    - name: mysql_query_performance_tab
      label: "Query Optimization"
    - name: mysql_historical_trends_tab
  ...
  elements:
    ...
    # =========================================================================
    - name: mysql_fleet_nav_banner
      type: text
      title_text: ""
      body_text: "<div style='display: flex; justify-content: space-between; align-items: center; padding: 4px 0 10px 0; border-bottom: 1px solid #E8EAED;'><div><div style='font-size: 20px; font-weight: 600; color: #1A73E8; margin-bottom: 2px;'>Cloud SQL Observability (MySQL)</div><div style='font-size: 13px; color: #5F6368;'>Dedicated instance deep dive, execution profiles, and query optimization for MySQL fleets.</div></div><div style='display: flex; gap: 8px;'><a href='/dashboards/operational_intelligence_cloud_sql::database_observability' style='display: inline-block; background-color: #FFFFFF; color: #1A73E8; font-size: 12px; font-weight: 500; padding: 6px 16px; border-radius: 18px; text-decoration: none; border: 1.5px solid #DADCE0;'>Fleet Observability</a><a href='/dashboards/mysql_observability::mysql_database_observability' style='display: inline-block; background-color: #1A73E8; color: #FFFFFF; font-size: 12px; font-weight: 600; padding: 6px 16px; border-radius: 18px; text-decoration: none; border: 1.5px solid #1A73E8;'>MySQL</a><a href='/dashboards/postgres_observability::postgres_database_observability' style='display: inline-block; background-color: #FFFFFF; color: #1A73E8; font-size: 12px; font-weight: 500; padding: 6px 16px; border-radius: 18px; text-decoration: none; border: 1.5px solid #DADCE0;'>PostgreSQL</a></div></div>"
      tab_name: mysql_fleet_overview_tab
      row: 0
      col: 0
      width: 24
      height: 2
    ...
    - name: mysql_fleet_total_instances
      ...
      note_display: hover
      note_text: "Total number of unique client IP addresses communicating with the MySQL database."
      tab_name: mysql_fleet_overview_tab
      row: 2
      col: 0
      width: 4
    ...
    - name: mysql_fleet_buffer_cache_hit
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Percentage of logical read requests served directly from InnoDB buffer pool without physical disk I/O."
      tab_name: mysql_fleet_overview_tab
      row: 2
      col: 4
      width: 5
    ...
    - name: mysql_fleet_connection_health
    ...
    - name: mysql_fleet_total_executions
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Total number of statements executed within the selected timeframe with period delta."
      tab_name: mysql_fleet_overview_tab
      row: 2
      col: 14
      width: 5
    ...
    - name: mysql_fleet_active_threads
      title: "Active Worker Threads"
      subtitle: "Executing server workers"
      model: mysql_observability
      explore: threads
      type: single_value
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Total server threads actively handling client requests or waiting in thread pool."
      tab_name: mysql_fleet_overview_tab
      row: 2
      col: 19
      width: 5
    ...
    - name: mysql_fleet_connection_trends
      title: "Connection Saturation Trends"
      subtitle: "Connected threads over time"
      model: mysql_observability
      explore: global_status
      type: looker_line
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Tracks connection saturation over time to spot concurrency spikes and capacity limits."
      tab_name: mysql_fleet_overview_tab
      row: 6
      col: 0
      width: 12
    ...
    - name: mysql_fleet_error_summary
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Monitors aborted connection attempts caused by network timeouts or authentication failures."
      tab_name: mysql_fleet_overview_tab
      row: 6
      col: 12
      width: 12
    ...
    - name: mysql_fleet_needs_attention
      title: "Connected Host Inventory"
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Inventory of client hostnames and IP addresses communicating with the database."
      tab_name: mysql_fleet_overview_tab
      row: 12
      col: 0
      width: 12
    ...
    - name: mysql_fleet_slow_queries_preview
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Top latency-inducing SQL statements ranked by average execution duration."
      tab_name: mysql_fleet_overview_tab
      row: 12
      col: 12
      width: 12
    ...
    # =========================================================================
    - name: mysql_dive_nav_banner
      type: text
      title_text: ""
      body_text: "<div style='display: flex; justify-content: space-between; align-items: center; padding: 4px 0 10px 0; border-bottom: 1px solid #E8EAED;'><div><div style='font-size: 20px; font-weight: 600; color: #1A73E8; margin-bottom: 2px;'>Cloud SQL Observability (MySQL) - Deep Dive</div><div style='font-size: 13px; color: #5F6368;'>Dedicated instance deep dive, execution profiles, and query optimization for MySQL fleets.</div></div><div style='display: flex; gap: 8px;'><a href='/dashboards/operational_intelligence_cloud_sql::database_observability' style='display: inline-block; background-color: #FFFFFF; color: #1A73E8; font-size: 12px; font-weight: 500; padding: 6px 16px; border-radius: 18px; text-decoration: none; border: 1.5px solid #DADCE0;'>Fleet Observability</a><a href='/dashboards/mysql_observability::mysql_database_observability' style='display: inline-block; background-color: #1A73E8; color: #FFFFFF; font-size: 12px; font-weight: 600; padding: 6px 16px; border-radius: 18px; text-decoration: none; border: 1.5px solid #1A73E8;'>MySQL</a><a href='/dashboards/postgres_observability::postgres_database_observability' style='display: inline-block; background-color: #FFFFFF; color: #1A73E8; font-size: 12px; font-weight: 500; padding: 6px 16px; border-radius: 18px; text-decoration: none; border: 1.5px solid #DADCE0;'>PostgreSQL</a></div></div>"
      tab_name: mysql_instance_deep_dive_tab
      row: 0
      col: 0
      width: 24
      height: 2

    - name: mysql_instance_active_threads
      title: "Active Threads"
      subtitle: "Server execution workers"
      model: mysql_observability
      explore: threads
      type: single_value
      fields: [threads.pop_active_threads_current, threads.pop_active_threads_change]
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Total active server threads handling connections."
      tab_name: mysql_instance_deep_dive_tab
      row: 2
      col: 0
      width: 6
    ...
    - name: mysql_instance_running_threads
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Count of server threads currently running active SQL commands."
      tab_name: mysql_instance_deep_dive_tab
      row: 2
      col: 6
      width: 6
    ...
    - name: mysql_instance_background_threads
      title: "Background Threads"
      subtitle: "Internal engine workers"
      model: mysql_observability
      explore: threads
      type: single_value
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Count of internal background workers managing storage engine tasks."
      tab_name: mysql_instance_deep_dive_tab
      row: 2
      col: 12
      width: 6
    ...
    - name: mysql_instance_active_connections
      title: "Active Connections"
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Current active client connection count."
      tab_name: mysql_instance_deep_dive_tab
      row: 2
      col: 18
      width: 6
    ...
    - name: mysql_instance_active_running_threads
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Compares total allocated threads against actively running threads."
      tab_name: mysql_instance_deep_dive_tab
      row: 6
      col: 0
      width: 24
    ...
    - name: mysql_instance_cpu_memory_trends
      title: "Thread Load by Process User"
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Distribution of active threads across database user accounts."
      tab_name: mysql_instance_deep_dive_tab
      row: 12
      col: 0
      width: 12
    ...
    - name: mysql_instance_iops
      title: "Connections Profile"
      subtitle: "Status variables distribution"
      model: mysql_observability
      explore: global_status
      type: looker_column
      fields: [global_status.variable_name, global_status.active_connections]
    ...
    # =========================================================================
    - name: mysql_query_nav_banner
      type: text
      title_text: ""
      body_text: "<div style='display: flex; justify-content: space-between; align-items: center; padding: 4px 0 10px 0; border-bottom: 1px solid #E8EAED;'><div><div style='font-size: 20px; font-weight: 600; color: #1A73E8; margin-bottom: 2px;'>Cloud SQL Observability (MySQL) - Query Optimization</div><div style='font-size: 13px; color: #5F6368;'>Diagnostic profiling of latency, lock contention, missing indexes, storage scan ratios, and temporary disk table spills.</div></div><div style='display: flex; gap: 8px;'><a href='/dashboards/operational_intelligence_cloud_sql::database_observability' style='display: inline-block; background-color: #FFFFFF; color: #1A73E8; font-size: 12px; font-weight: 500; padding: 6px 16px; border-radius: 18px; text-decoration: none; border: 1.5px solid #DADCE0;'>Fleet Observability</a><a href='/dashboards/mysql_observability::mysql_database_observability' style='display: inline-block; background-color: #1A73E8; color: #FFFFFF; font-size: 12px; font-weight: 600; padding: 6px 16px; border-radius: 18px; text-decoration: none; border: 1.5px solid #1A73E8;'>MySQL</a><a href='/dashboards/postgres_observability::postgres_database_observability' style='display: inline-block; background-color: #FFFFFF; color: #1A73E8; font-size: 12px; font-weight: 500; padding: 6px 16px; border-radius: 18px; text-decoration: none; border: 1.5px solid #DADCE0;'>PostgreSQL</a></div></div>"
      tab_name: mysql_query_performance_tab
      row: 0
      col: 0
      width: 24
      height: 2
    ...
    - name: mysql_total_executions_kpi
      title: "Total Query Executions"
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Total statements executed across MySQL instances recorded by performance_schema since the server was started (cumulative uptime counters)."
      tab_name: mysql_query_performance_tab
      row: 2
      col: 0
      width: 4
    ...
    - name: mysql_avg_exec_time_kpi
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Average execution latency across all recorded SQL statements."
      tab_name: mysql_query_performance_tab
      row: 2
      col: 4
      width: 4
    ...
    - name: mysql_peak_exec_time_kpi
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Maximum single execution duration recorded across all query digests."
      tab_name: mysql_query_performance_tab
      row: 2
      col: 8
      width: 4
    ...
    - name: mysql_total_lock_time_kpi
    ...
    - name: mysql_scan_efficiency_kpi
    ...
    - name: mysql_disk_spill_kpi
      title: "Temp Tables on Disk"
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Total internal temporary tables forced to disk due to exceeding tmp_table_size or max_heap_table_size limits."
      tab_name: mysql_query_performance_tab
      row: 2
      col: 20
      width: 4
    ...
    - name: mysql_top_10_slowest_queries
      title: "Top 10 Slowest Statements"
      subtitle: "Ranked by average latency"
      model: mysql_observability
      explore: events_statements_summary_by_digest
    ...
    - name: mysql_index_starvation_hotspots
    ...
    - name: mysql_disk_spill_statements
      title: "Disk I/O Spill & Sort Operations"
      subtitle: "Statements creating on-disk temporary tables"
      model: mysql_observability
      explore: events_statements_summary_by_digest
      type: looker_grid
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Identifies statements spilling temporary tables to disk or performing full sort scans, causing heavy storage I/O."
      tab_name: mysql_query_performance_tab
      row: 14
      col: 14
      width: 10
    ...
    - name: mysql_query_high_lock_time
    ...
    - name: mysql_query_execution_distribution
    ...
    # =========================================================================
    - name: mysql_hist_nav_banner
      type: text
      title_text: ""
      body_text: "<div style='display: flex; justify-content: space-between; align-items: center; padding: 4px 0 10px 0; border-bottom: 1px solid #E8EAED;'><div><div style='font-size: 20px; font-weight: 600; color: #1A73E8; margin-bottom: 2px;'>Cloud SQL Observability (MySQL) - Historical Telemetry</div><div style='font-size: 13px; color: #5F6368;'>Hourly statement execution cadence, latency regressions, and Period-over-Period query throughput benchmarks for MySQL.</div></div><div style='display: flex; gap: 8px;'><a href='/dashboards/operational_intelligence_cloud_sql::database_observability' style='display: inline-block; background-color: #FFFFFF; color: #1A73E8; font-size: 12px; font-weight: 500; padding: 6px 16px; border-radius: 18px; text-decoration: none; border: 1.5px solid #DADCE0;'>Fleet Observability</a><a href='/dashboards/mysql_observability::mysql_database_observability' style='display: inline-block; background-color: #1A73E8; color: #FFFFFF; font-size: 12px; font-weight: 600; padding: 6px 16px; border-radius: 18px; text-decoration: none; border: 1.5px solid #1A73E8;'>MySQL</a><a href='/dashboards/postgres_observability::postgres_database_observability' style='display: inline-block; background-color: #FFFFFF; color: #1A73E8; font-size: 12px; font-weight: 500; padding: 6px 16px; border-radius: 18px; text-decoration: none; border: 1.5px solid #DADCE0;'>PostgreSQL</a></div></div>"
      tab_name: mysql_historical_trends_tab
      row: 0
      col: 0
      width: 24
      height: 2
    ...
    - name: mysql_hist_total_queries
      ...
      filters:
        statement_history_snapshot.engine_type: "MySQL"
      listen:
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Total unique normalized SQL statements tracked for MySQL across historical snapshot intervals."
      tab_name: mysql_historical_trends_tab
      row: 2
      col: 0
      width: 6
    ...
    - name: mysql_hist_total_executions
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Total MySQL query executions within the selected comparison window with period-over-period delta throughput."
      tab_name: mysql_historical_trends_tab
      row: 2
      col: 6
      width: 6
    ...
    - name: mysql_hist_avg_latency
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Average execution latency across MySQL statements with period-over-period delta regression tracking."
      tab_name: mysql_historical_trends_tab
      row: 2
      col: 12
      width: 6
    ...
    - name: mysql_hist_lock_time
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Total cumulative lock wait duration across MySQL statements."
      tab_name: mysql_historical_trends_tab
      row: 2
      col: 18
      width: 6
    ...
    - name: mysql_hist_hourly_execution_trend
      title: "Hourly Execution Throughput"
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Hourly query execution cadence for MySQL workloads."
      tab_name: mysql_historical_trends_tab
      row: 6
      col: 0
      width: 12
    ...
    - name: mysql_hist_hourly_latency_trend
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Hourly average query execution latency for MySQL workloads."
      tab_name: mysql_historical_trends_tab
      row: 6
      col: 12
      width: 12
    ...
    - name: mysql_hist_top_latency_bottlenecks
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Ranks top MySQL statements by total cumulative latency impact."
      tab_name: mysql_historical_trends_tab
      row: 14
      col: 0
      width: 14
    ...
    - name: mysql_hist_disk_spill_trends
      title: "Disk Spill & Storage Scan Trends"
      subtitle: "Historical temporary table spills and rows examined"
      model: mysql_observability
      explore: statement_history_snapshot
      type: looker_grid
      fields: [statement_history_snapshot.query_text, statement_history_snapshot.total_executions, statement_history_snapshot.delta_rows_examined, statement_history_snapshot.delta_no_index_used, statement_history_snapshot.delta_tmp_disk_tables]
      ...
      note_state: collapsed
      note_display: hover
      note_text: "Monitors statements generating on-disk temporary table spills and full table scans."
      tab_name: mysql_historical_trends_tab
      row: 14
      col: 14
      width: 10
